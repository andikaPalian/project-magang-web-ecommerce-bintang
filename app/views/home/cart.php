<div class="bg-[#F8F9FA] min-h-screen pt-10 pb-20 font-sans text-black flex flex-col relative">
  ...
  <div id="custom-confirm-modal" class="fixed inset-0 z-[100] hidden items-center justify-center bg-gray-900/80 backdrop-blur-sm transition-opacity opacity-0 duration-300">
    <div class="modal-box bg-white border-4 border-black p-8 w-[90%] max-w-sm shadow-[12px_12px_0_0_#000] transform translate-y-10 transition-all duration-300 flex flex-col items-center">
      ...
      <h3 class="text-2xl font-black uppercase text-center mb-2">DROP ITEM?</h3>
      <p class="text-xs font-bold text-center text-gray-600 mb-8 uppercase">Confirm to remove this gear from your loadout.</p>
      <div class="flex w-full space-x-4">
        <button id="btn-cancel-modal" class="flex-1 bg-white border-4 border-black hover:bg-gray-100 text-black font-black uppercase tracking-widest py-3 shadow-[4px_4px_0_0_#000] active:translate-y-[2px] active:translate-x-[2px] active:shadow-none transition-all">ABORT</button>
        <button id="btn-confirm-modal" class="flex-1 bg-[#FF5757] border-4 border-black hover:bg-red-700 text-white font-black uppercase tracking-widest py-3 shadow-[4px_4px_0_0_#000] active:translate-y-[2px] active:translate-x-[2px] active:shadow-none transition-all">DROP IT</button>
      </div>
    </div>
  </div>
