...
class AdminTokoModel
{
  ...
  public function getSalesHistory(int $location_id): array
  {
    $this->db->query("SELECT o.id, o.invoice_number, o.created_at, o.grand_total, o.payment_method, o.payment_status, u.name AS kasir_name FROM orders o JOIN users u ON o.user_id = u.id WHERE o.fulfilled_by_location_id = :location_id ORDER BY o.created_at DESC");
    $this->db->bind('location_id', $location_id);
